...
export default function HomePage(props) {
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4  justify-center pb-20'>
            <h1 className='font-semibold text-5xl sm:text-6xl md:text-7xl'>Tran<span className='text-purple-400 bold'>Scribe</span></h1>
            <h3 className='font-medium md:text-lg'>Record <span className='text-purple-400'>&rarr;</span> Transcribe <span className='text-purple-400'>&rarr;</span> Translate</h3>
            ...
            <p className='text-base'>Or <label className='text-purple-400 cursor-pointer hover:text-purple-600 duration-200'>upload <input onChange={(e) => {
